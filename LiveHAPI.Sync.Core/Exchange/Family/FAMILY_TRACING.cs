...
namespace LiveHAPI.Sync.Core.Exchange.Family
{
    public class FAMILY_TRACING
    {
        ...
        private FAMILY_TRACING(string tracingDate, string reminderDate, int tracingMode, int tracingOutcome, int consent, string bookingDate,int reasonnotcontacted,string reasonnotcontactedother)
        {
